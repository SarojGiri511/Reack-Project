      ...
      <div className="grid grid-cols-4 gap-4 md:px-32 px-20 py-10">
        ...
        <div className="col-span-2">
          ...
          <p className="text-sm text-gray-600">
            ...
            debitis? Quis, vel. A asperiores quam, porro tempore consequuntur
            dicta minus impedit maxime corrupti ea non!
          </p>
          <div className="flex items-center py-2">
            <button
              onClick={decrement}
        ...
        <div className="border-l border-gray-200 pl-2 text-gray-700">
          <p className="flex items-center gap-2">
            <RiTruckFill /> Free Delivery{" "}
          </p>
          <p className="flex items-center gap-2">
            <Ri24HoursFill /> 24/7 Support{" "}
          </p>
          <p className="flex items-center gap-2">
            <RiVerifiedBadgeFill /> 100% Original{" "}
          </p>
          <p className="flex items-center gap-2">
            <RiBankCard2Fill /> Secure Payments{" "}
          </p>
        </div>
      </div>
      <Footer />
